...
def parse_args():
    ...
    if True:
        ...
        args = parser.parse_args(['--android', 'focusInterface','--abi', 'armeabi-v7a','--build-root', 'C:/src/hifi/android/apps/focusInterface/.externalNativeBuild/cmake/debug/armeabi-v7a'])
    return args
